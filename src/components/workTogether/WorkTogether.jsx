    ...
    <div className="py-25 max-w-169 mx-auto px-2">
      <div className="text-center">
        <p className="text-white md:font-semibold text-2xl sm:text-3xl md:text-5xl pb-8">
          Need Professional Translation Services? Let's discuss your project!
        </p>
        <p className="text-[#A5ACB5] text-xs sm:text-lg font-normal text-center pb-8">
          I'm always ready to help with your English ↔ Kinyarwanda translation needs, 
          content writing, and business support services. Let's connect and create 
          accurate, culturally appropriate solutions together.
        </p>
        <a
          href="#contact"
