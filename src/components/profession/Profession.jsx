      ...
      <div className="flex flex-col justify-between h-fit md:pe-8 lg:pe-35.75 max-md:text-center my-auto">
        ...
        <div className="mt-6 text-[14px]">
          <p className="text-xs sm:text-lg font-normal text-gray-400 mb-4">
            I offer professional and reliable services including translation, content writing, 
            business support, and digital skills training.
          </p>
          <p className="text-xs sm:text-lg font-normal text-gray-400">
            My approach combines linguistic expertise with cultural understanding to deliver
            solutions that are both accurate and culturally appropriate for clients worldwide.
          </p>
        </div>
        <a
          href="#contact"
